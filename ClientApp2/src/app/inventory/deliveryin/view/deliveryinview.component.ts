...
@Component({
  selector: 'app-deliveryinview',
  templateUrl: './deliveryinview.component.html',
  styleUrls: ['./deliveryinview.component.scss']
})
export class DeliveryInViewComponent implements OnInit {
  userAccess: any = {};
  branchdtl: any = {};
  today = '';
  invdata: any = {};
  ...
  displayedColumns: string[] = ['name', 'invno','qty', 'ucode', 'price', 'amount', 'cgst', 'sgst', 'total'];
  ...
  getInvoiceData(invid: number, isprint: boolean) {
    this.invservice.InvoiceDataService('api/delivery/view/', { IVID: invid, IsPrint: isprint })
      .subscribe(
        data => {
  ...
  print(): void {
    ...
    printcss = `@media print { 
      ...
      .page-break{page-break-before:always;page-break-inside: avoid;clear:both} 
