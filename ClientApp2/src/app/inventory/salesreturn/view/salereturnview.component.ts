...
@Component({
  ...
  templateUrl: './salereturnview.component.html',
  styleUrls: ['./salereturnview.component.scss']
})
export class SaleReturnViewComponent implements OnInit {
  ...
  getInvoiceData(invid: number, isprint: boolean) {
    this.invservice.InvoiceDataService('api/salesreturn/view/', { IVID: invid, IsPrint: isprint })
      .subscribe(
        data => {
