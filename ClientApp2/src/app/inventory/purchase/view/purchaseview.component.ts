...
export class PurchaseViewComponent implements OnInit {
  ...
  displayedColumns: string[] = ['name', 'qty','weight', 'ucode', 'price', 'amount',   'cgst', 'sgst','kfcess', 'total'];
  ...
  getInvoiceData(invid: number, isprint: boolean) {
    this.invservice.InvoiceDataService('api/purchase/view/', { IVID: invid, IsPrint: isprint })
      .subscribe(
        data => {
