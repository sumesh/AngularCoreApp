...
export class ServiceViewComponent implements OnInit {
  ...
  displayedColumns: string[] = ['name', 'qty', 'ucode', 'price', 'amount', 'discount', 'cgst', 'sgst','kfcess', 'total'];
  ...
  getInvoiceData(invid: number, isprint: boolean) {
    this.invservice.InvoiceDataService('api/service/view/', { IVID: invid, IsPrint: isprint })
      .subscribe(
        data => {
